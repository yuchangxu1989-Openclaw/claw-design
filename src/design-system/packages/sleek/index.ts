...
export const SLEEK_PACKAGE: DesignSystemPackage = {
  id: 'sleek',
  name: 'Sleek',
  version: '1.0.0',
  description: 'Modern & Minimal. Modern minimalist aesthetic with clean lines, intentional color palette, subtle interactions, and consistent spacing.',
