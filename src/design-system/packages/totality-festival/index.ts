...
export const TOTALITY_FESTIVAL_PACKAGE: DesignSystemPackage = {
  ...
  tokens: {
    colors: {
      ...
      'outline': '#999077',
      'do': '#ffd700',
      'favor-primary': '#fff6df',
      'use-secondary': '#bdf4ff'
    },
    spacing: {
      unit: '8px',
      values: {
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #fff6df, #ffd700, #bdf4ff, #00e3fd, #fcf3ff...',
