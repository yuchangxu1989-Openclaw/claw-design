...
export const PLAYSTATION_PACKAGE: DesignSystemPackage = {
  id: 'playstation',
  name: 'Playstation',
  version: '1.0.0',
  description: 'Media & Consumer. Gaming console retail. Three-surface channel layout, quiet-authority display type, cyan hover-scale.',

  tokens: {
    colors: {
      'playstation-blue': '#0070cc',
      'console-black': '#000000',
      'playstation-cyan': '#1eaedb',
      ...
      'warning-red': '#c81b3a',
      'light-section-gradient': '#ffffff',
      'dark-section-gradient': '#121314'
    },
    spacing: {
      unit: '8px',
      values: {
  ...
  components: [
    ...
    },
    {
      ...
      properties: {
        'background': '#ffffff',
        'border-radius': '4px',
        'box-shadow': 'rgba(0, 0, 0, 0.06) 0px 5px 9px 0px',
        'padding': '24px',
        'border': 'none'
      },
    },
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #0070cc, #000000, #1eaedb, #1883fd, #0068bd...',
