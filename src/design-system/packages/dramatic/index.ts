...
export const DRAMATIC_PACKAGE: DesignSystemPackage = {
  id: 'dramatic',
  name: 'Dramatic',
  version: '1.0.0',
  description: 'Bold & Expressive. High-contrast, theatrical design with bold layouts, immersive visuals, and unconventional compositions that command attention.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #8B5CF6, #F43F5E, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Outfit, system-ui, sans-serif, Outfit, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
