...
export const AGENTIC_PACKAGE: DesignSystemPackage = {
  id: 'agentic',
  name: 'Agentic',
  version: '1.0.0',
  description: 'Themed & Unique. Conversational AI-first interface with minimal controls, clear outcomes, and delegated task flows for agentic workflows.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #FF5701, #F6F6F1, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Playfair Display, system-ui, sans-serif, Playfair Display, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
