...
export const LINGO_PACKAGE: DesignSystemPackage = {
  id: 'lingo',
  name: 'Lingo',
  version: '1.0.0',
  description: 'Creative & Artistic. Playful, minimal design with bright colors, rounded shapes, tactile 3D borders, and friendly illustrations for approachable interfaces.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #58CC02, #CE82FF, #58CC02, #FFC800, #FF4B4B...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Nunito, system-ui, sans-serif, Nunito, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
