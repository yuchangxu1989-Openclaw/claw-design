...
export const CORPORATE_PACKAGE: DesignSystemPackage = {
  id: 'corporate',
  name: 'Corporate',
  version: '1.0.0',
  description: 'Professional & Corporate. Professional, brand-aligned design with structured grids, minimalist layouts, and consistent enterprise patterns.',
  ...
  constraints: {
    enforce: [
      ...
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Poppins, system-ui, sans-serif, Open Sans, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
