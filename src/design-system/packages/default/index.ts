...
export const DEFAULT_PACKAGE: DesignSystemPackage = {
  id: 'default',
  name: 'Default',
  version: '1.0.0',
  description: 'Starter. A clean, product-oriented default. Use when the brief doesn\'t call for a',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #FAFAFA, #111111, #2F6FEB, #6B6B6B, #E5E5E5...',
