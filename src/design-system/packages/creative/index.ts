...
export const CREATIVE_PACKAGE: DesignSystemPackage = {
  id: 'creative',
  name: 'Creative',
  version: '1.0.0',
  description: 'Creative & Artistic. Playful, character-driven design with expressive typography and bold graphics for landing pages and creative projects.',
  ...
  tokens: {
    ...
    typography: {
      fontFamily: {
        ...
        body: 'Bangers, system-ui, sans-serif',
      },
      sizes: {
        'xs': '11px',
        'sm': '12px',
  ...
  constraints: {
    enforce: [
      ...
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Bangers, system-ui, sans-serif, Bangers, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
