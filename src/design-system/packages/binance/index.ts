...
export const BINANCE_PACKAGE: DesignSystemPackage = {
  id: 'binance',
  name: 'Binance',
  version: '1.0.0',
  description: 'Fintech & Crypto. Crypto exchange. Bold yellow accent on monochrome, trading-floor urgency.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #F0B90B, #FFD000, #F8D12F, #D0980B, #1EAEDB...',
