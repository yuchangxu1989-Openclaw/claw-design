...
export const XIAOHONGSHU_PACKAGE: DesignSystemPackage = {
  id: 'xiaohongshu',
  name: 'Xiaohongshu',
  version: '1.0.0',
  description: 'Media & Consumer. Lifestyle UGC social platform. Singular brand red, generous radius, content-first.',

  tokens: {
    colors: {
      'brand-red-token': '#FF2442',
      'brand-red-component': '#FF2E4D',
      'star-yellow': '#FDBC5F',
      'surface': '#FFFFFF',
      'canvas': '#F5F5F5',
      'subtle': '#FAFAFA',
      'opaque-separator': '#EAEAEA',
      'success': '#02B940',
      'warning': '#FF7D03',
      'info': '#3D8AF5',
      'link': '#133667',
      'brand-primary': '#FF2E4D',
      'no-box-shadow-by-default': '#F5F5F5',
      'singular-brand-red': '#FF2442',
      'background': '#FF2442',
      'text': '#FFFFFF',
      'numeric-badge': '#FF2442',
      'brand': '#FF2442'
    },
    spacing: {
      unit: '8px',
    ...
    typography: {
      fontFamily: {
        heading: '#FF2442, system-ui, sans-serif',
        body: '#FF2442, system-ui, sans-serif',
      },
      sizes: {
        'xs': '11px',
        'sm': '12px',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #FF2442, #FF2E4D, #FDBC5F, #FFFFFF, #F5F5F5...',
