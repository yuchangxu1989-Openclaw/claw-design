...
export const CURSOR_PACKAGE: DesignSystemPackage = {
  id: 'cursor',
  name: 'Cursor',
  version: '1.0.0',
  description: 'Developer Tools. AI-first code editor. Sleek dark interface, gradient accents.',
  ...
  components: [
    ...
    },
    {
      ...
      properties: {
        'background': '#ffffff',
        'border-radius': '8px',
        'box-shadow': 'rgba(0,0,0,0.14) 0px 28px 70px, rgba(0,0,0,0.1) 0px 14px 32p',
        'padding': '24px',
        'border': 'none'
      },
    },
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #26251e, #f2f1ed, #e6e5e0, #ffffff, #000000...',
