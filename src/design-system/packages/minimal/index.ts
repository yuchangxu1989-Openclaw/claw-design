...
export const MINIMAL_PACKAGE: DesignSystemPackage = {
  id: 'minimal',
  name: 'Minimal',
  version: '1.0.0',
  description: 'Modern & Minimal. Stripped-back design emphasizing whitespace, clean typography, and restrained color for maximum clarity and focus.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #0C0C09, #312C85, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Inter, system-ui, sans-serif, Open Sans, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
