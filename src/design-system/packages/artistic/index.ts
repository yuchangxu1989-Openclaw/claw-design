...
export const ARTISTIC_PACKAGE: DesignSystemPackage = {
  id: 'artistic',
  name: 'Artistic',
  version: '1.0.0',
  description: 'Creative & Artistic. High-contrast, expressive style with creative typography and bold color choices for visually striking interfaces.',
