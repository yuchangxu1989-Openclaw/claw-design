...
export const WARM_EDITORIAL_PACKAGE: DesignSystemPackage = {
  id: 'warm-editorial',
  name: 'Warm Editorial',
  version: '1.0.0',
  description: 'Starter. A serif-led magazine aesthetic. Terracotta accent on warm off-white paper —',

  tokens: {
    colors: {
      'background': '#FAF7F2',
      'foreground': '#1C1A17',
      'accent-primary': '#C0512F',
      'accent-secondary': '#2F5B4F',
      'muted': '#8A817A',
      'surface': '#FFFFFF'
    },
    spacing: {
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #FAF7F2, #1C1A17, #C0512F, #2F5B4F, #8A817A...',
