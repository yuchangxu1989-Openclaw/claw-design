...
export const CAL_PACKAGE: DesignSystemPackage = {
  id: 'cal',
  name: 'Cal',
  version: '1.0.0',
  description: 'Productivity & SaaS. Open-source scheduling. Clean neutral UI, developer-oriented simplicity.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #242424, #111111, #ffffff, #0099ff, #3b82f6...',
