...
export const VINTAGE_PACKAGE: DesignSystemPackage = {
  id: 'vintage',
  name: 'Vintage',
  version: '1.0.0',
  description: 'Retro & Nostalgic. 1950s-1990s nostalgia with skeuomorphic touches, grainy textures, retro color palettes, and pixel-style typography.',
  ...
  tokens: {
    ...
    typography: {
      fontFamily: {
        heading: 'Silkscreen, system-ui, sans-serif',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #008080, #C0C0C0, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Silkscreen, system-ui, sans-serif, Silkscreen, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
