...
export const APPLICATION_PACKAGE: DesignSystemPackage = {
  id: 'application',
  name: 'Application',
  version: '1.0.0',
  description: 'Professional & Corporate. App dashboard with purple-themed aesthetic, top-bar navigation, card-based layouts, and developer-first workflows.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #9333EA, #A855F7, #10B981, #F59E0B, #EF4444...',
