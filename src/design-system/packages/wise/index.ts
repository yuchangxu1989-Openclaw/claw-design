...
export const WISE_PACKAGE: DesignSystemPackage = {
  id: 'wise',
  name: 'Wise',
  version: '1.0.0',
  description: 'Fintech & Crypto. Money transfer. Bright green accent, friendly and clear.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #0e0f0c, #9fe870, #163300, #e2f6d5, #cdffad...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 16px, 40px, 9999px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
