...
export const NEOBRUTALISM_PACKAGE: DesignSystemPackage = {
  id: 'neobrutalism',
  name: 'Neobrutalism',
  version: '1.0.0',
  description: 'Bold & Expressive. Modern take on brutalism with bold borders, vivid accent colors, and raw, high-contrast layouts on warm surfaces.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #FDC800, #432DD7, #16A34A, #D97706, #DC2626...',
