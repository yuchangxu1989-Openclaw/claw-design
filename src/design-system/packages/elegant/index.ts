...
export const ELEGANT_PACKAGE: DesignSystemPackage = {
  id: 'elegant',
  name: 'Elegant',
  version: '1.0.0',
  description: 'Professional & Corporate. Graceful, refined aesthetic with delicate typography, minimal palettes, and polished layouts that exude sophistication.',
  ...
  tokens: {
    ...
    typography: {
      fontFamily: {
        heading: 'Google Sans, system-ui, sans-serif',
  ...
  constraints: {
    enforce: [
      ...
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Google Sans, system-ui, sans-serif, Google Sans, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
