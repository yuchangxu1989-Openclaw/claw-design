...
export const FERRARI_PACKAGE: DesignSystemPackage = {
  id: 'ferrari',
  name: 'Ferrari',
  version: '1.0.0',
  description: 'Automotive. Luxury automotive. Chiaroscuro editorial, Ferrari Red accents, cinematic black.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #DA291C, #FFFFFF, #B01E0A, #9D2211, #FFF200...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 2px, 8px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
