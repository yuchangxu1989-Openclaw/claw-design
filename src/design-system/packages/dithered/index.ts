...
export const DITHERED_PACKAGE: DesignSystemPackage = {
  id: 'dithered',
  name: 'Dithered',
  version: '1.0.0',
  description: 'Retro & Nostalgic. Dot-pattern rendering technique that simulates shades with a limited palette for nostalgic, retro, high-contrast visuals.',
  ...
  constraints: {
    enforce: [
      ...
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Space Grotesk, system-ui, sans-serif, Open Sans, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
