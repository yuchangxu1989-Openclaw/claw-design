...
export const TETRIS_PACKAGE: DesignSystemPackage = {
  id: 'tetris',
  name: 'Tetris',
  version: '1.0.0',
  description: 'Themed & Unique. Classic block-game inspired design with playful colors, bold display fonts, and compact, high-energy layouts.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #1C202B, #7107E7, #16A34A, #D97706, #DC2626...',
