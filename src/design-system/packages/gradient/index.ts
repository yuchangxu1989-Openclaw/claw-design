...
export const GRADIENT_PACKAGE: DesignSystemPackage = {
  id: 'gradient',
  name: 'Gradient',
  version: '1.0.0',
  description: 'Morphism & Effects. Smooth color transitions and gradient-rich surfaces for modern, playful interfaces with visual depth.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #990FFA, #E60076, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Space Grotesk, system-ui, sans-serif, Montserrat, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
