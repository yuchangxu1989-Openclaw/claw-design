...
export const MODERN_PACKAGE: DesignSystemPackage = {
  id: 'modern',
  name: 'Modern',
  version: '1.0.0',
  description: 'Modern & Minimal. Contemporary editorial style with serif typography, minimal palettes, and clean layouts for polished digital products.',
  ...
  tokens: {
    ...
    typography: {
      fontFamily: {
        ...
        body: 'IBM Plex Serif, system-ui, sans-serif',
      },
      sizes: {
        'xs': '11px',
        'sm': '12px',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #553F83, #111111, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: IBM Plex Serif, system-ui, sans-serif, IBM Plex Serif, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
