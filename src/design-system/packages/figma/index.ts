...
export const FIGMA_PACKAGE: DesignSystemPackage = {
  id: 'figma',
  name: 'Figma',
  version: '1.0.0',
  description: 'Design & Creative. Collaborative design tool. Vibrant multi-color, playful yet professional.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #000000, #ffffff',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: figmaSans, system-ui, sans-serif, figmaSans, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
