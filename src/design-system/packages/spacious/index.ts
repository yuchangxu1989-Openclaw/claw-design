...
export const SPACIOUS_PACKAGE: DesignSystemPackage = {
  id: 'spacious',
  name: 'Spacious',
  version: '1.0.0',
  description: 'Layout & Structure. Generous whitespace, consistent padding, and grid-based layouts for clean, readable, and breathing interfaces.',
  ...
  constraints: {
    enforce: [
      ...
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Montserrat, system-ui, sans-serif, Open Sans, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
