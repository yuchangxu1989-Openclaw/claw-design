...
export const RUNWAYML_PACKAGE: DesignSystemPackage = {
  id: 'runwayml',
  name: 'Runwayml',
  version: '1.0.0',
  description: 'AI & LLM. AI video generation. Cinematic dark UI, media-rich layout.',
  ...
  components: [
    ...
    },
    {
      ...
      properties: {
        'background': '#ffffff',
        'border-radius': '4px',
        'box-shadow': 'zero — no shadows on any element',
        'padding': '24px',
        'border': 'none'
      },
    },
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #000000, #030303, #1a1a1a, #ffffff, #fefefe...',
