...
export const REFINED_PACKAGE: DesignSystemPackage = {
  id: 'refined',
  name: 'Refined',
  version: '1.0.0',
  description: 'Modern & Minimal. Carefully curated, modern minimal style with elegant serif typography and understated, sophisticated palettes.',
