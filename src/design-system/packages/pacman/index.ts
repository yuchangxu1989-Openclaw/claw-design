...
export const PACMAN_PACKAGE: DesignSystemPackage = {
  id: 'pacman',
  name: 'Pacman',
  version: '1.0.0',
  description: 'Themed & Unique. Retro arcade-inspired design with pixel fonts, dotted borders, playful high-contrast colors, and 8-bit game aesthetics.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #2A3FE5, #F4B9B0, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Press Start 2P, system-ui, sans-serif, Press Start 2P, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
