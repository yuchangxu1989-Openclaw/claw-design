...
export const THEVERGE_PACKAGE: DesignSystemPackage = {
  id: 'theverge',
  name: 'Theverge',
  version: '1.0.0',
  description: 'Media & Consumer. Tech editorial media. Acid-mint and ultraviolet accents, Manuka display, rave-flyer story tiles.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #3cffd0, #5200ff, #309875, #3860be, #1eaedb...',
