...
export const RESEND_PACKAGE: DesignSystemPackage = {
  id: 'resend',
  name: 'Resend',
  version: '1.0.0',
  description: 'Productivity & SaaS. Email API. Minimal dark theme, monospace accents.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #000000, #f0f0f0, #ffffff, #ff5900, #ff801f...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 4px, 16px, 9999px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
