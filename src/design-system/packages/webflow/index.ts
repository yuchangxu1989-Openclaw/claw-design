...
export const WEBFLOW_PACKAGE: DesignSystemPackage = {
  id: 'webflow',
  name: 'Webflow',
  version: '1.0.0',
  description: 'Design & Creative. Visual web builder. Blue-accented, polished marketing site aesthetic.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #080808, #146ef5, #3b89ff, #006acc, #0055d4...',
