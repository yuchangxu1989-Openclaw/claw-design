...
export const OLLAMA_PACKAGE: DesignSystemPackage = {
  id: 'ollama',
  name: 'Ollama',
  version: '1.0.0',
  description: 'AI & LLM. Run LLMs locally. Terminal-first, monochrome simplicity.',
  ...
  components: [
    ...
    },
    {
      ...
      properties: {
        'background': '#ffffff',
        'border-radius': '4px',
        'box-shadow': '**none** — zero shadows on any element',
        'padding': '24px',
        'border': 'none'
      },
    },
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #000000, #262626, #090909, #ffffff, #fafafa...',
