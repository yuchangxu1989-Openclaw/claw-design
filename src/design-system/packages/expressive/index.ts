...
export const EXPRESSIVE_PACKAGE: DesignSystemPackage = {
  id: 'expressive',
  name: 'Expressive',
  version: '1.0.0',
  description: 'Bold & Expressive. Vibrant, personality-driven design with bold colors, playful graphics, and dynamic layouts that balance creativity with structure.',
  ...
  tokens: {
    ...
    typography: {
      fontFamily: {
        heading: 'IBM Plex Mono, system-ui, sans-serif',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #DB2777, #2563EB, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: IBM Plex Mono, system-ui, sans-serif, IBM Plex Mono, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
