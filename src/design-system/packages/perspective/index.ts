...
export const PERSPECTIVE_PACKAGE: DesignSystemPackage = {
  id: 'perspective',
  name: 'Perspective',
  version: '1.0.0',
  description: 'Layout & Structure. Spatial depth design with isometric views, vanishing points, and layered elements that guide attention through 3D-like realism.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #00BD7D, #00BD7D, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Oswald, system-ui, sans-serif, Poppins, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
