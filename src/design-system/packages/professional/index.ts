...
export const PROFESSIONAL_PACKAGE: DesignSystemPackage = {
  id: 'professional',
  name: 'Professional',
  version: '1.0.0',
  description: 'Professional & Corporate. Polished, business-ready design with modern typography, structured layouts, and a trustworthy visual identity.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #FECE14, #000000, #16A34A, #D97706, #DC2626...',
