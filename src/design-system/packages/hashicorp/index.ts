...
export const HASHICORP_PACKAGE: DesignSystemPackage = {
  id: 'hashicorp',
  name: 'Hashicorp',
  version: '1.0.0',
  description: 'Backend & Data. Infrastructure automation. Enterprise-clean, black and white.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #000000, #15181e, #0d0e12, #f1f2f3, #d5d7db...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 2px, 3px, 4px, 5px, 8px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
