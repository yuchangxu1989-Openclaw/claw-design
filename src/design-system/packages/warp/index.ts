...
export const WARP_PACKAGE: DesignSystemPackage = {
  id: 'warp',
  name: 'Warp',
  version: '1.0.0',
  description: 'Developer Tools. Modern terminal. Dark IDE-like interface, block-based command UI.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #faf9f6, #353534, #868584, #afaeac, #666469...',
