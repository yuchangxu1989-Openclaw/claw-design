...
export const SENTRY_PACKAGE: DesignSystemPackage = {
  id: 'sentry',
  name: 'Sentry',
  version: '1.0.0',
  description: 'Backend & Data. Error monitoring. Dark dashboard, data-dense, pink-purple accent.',
  ...
  tokens: {
    colors: {
      ...
      'input-white': '#ffffff',
      'input-border': '#cfcfdb',
      'default-on-dark': '#ffffff',
      'hover': '#6a5fc1',
      'purple-links': '#6a5fc1',
      'lime-accent-links': '#c2ef4e',
      'dark-context-links': '#362d59',
      'background': '#79628c'
    },
    spacing: {
      unit: '8px',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #1f1633, #150f23, #362d59, #6a5fc1, #79628c...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 6px, 8px, 12px, 13px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
