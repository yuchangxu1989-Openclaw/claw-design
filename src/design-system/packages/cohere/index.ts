...
export const COHERE_PACKAGE: DesignSystemPackage = {
  id: 'cohere',
  name: 'Cohere',
  version: '1.0.0',
  description: 'AI & LLM. Enterprise AI platform. Vibrant gradients, data-rich dashboard aesthetic.',
  ...
  components: [
    ...
    },
    {
      ...
      properties: {
        'background': '#ffffff',
        'border-radius': '20px',
        'box-shadow': 'minimal — Cohere relies on background color and borders rath',
        'padding': '24px',
        'border': 'none'
      },
    },
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #000000, #212121, #17171c, #1863dc, #4c6ee6...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 20px, 60px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
