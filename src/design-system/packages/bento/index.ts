...
export const BENTO_PACKAGE: DesignSystemPackage = {
  id: 'bento',
  name: 'Bento',
  version: '1.0.0',
  description: 'Layout & Structure. Modular grid layout with card-like blocks, clear hierarchy, soft spacing, and subtle visual contrast for organized, scannable interfaces.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #FAD4C0, #80A1C1, #16A34A, #D97706, #DC2626...',
