...
export const FRAMER_PACKAGE: DesignSystemPackage = {
  id: 'framer',
  name: 'Framer',
  version: '1.0.0',
  description: 'Design & Creative. Website builder. Bold black and blue, motion-first, design-forward.',
  ...
  tokens: {
    colors: {
      ...
      'dark-surface-card': '#090909',
      'blue-glow-auras': '#0099ff',
      'use-pure-black': '#000000',
      'use-framer-blue': '#0099ff'
    },
    spacing: {
      unit: '8px',
      values: {
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #000000, #ffffff, #0099ff, #a6a6a6, #090909...',
