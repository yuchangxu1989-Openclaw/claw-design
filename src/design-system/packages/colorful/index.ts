...
export const COLORFUL_PACKAGE: DesignSystemPackage = {
  id: 'colorful',
  name: 'Colorful',
  version: '1.0.0',
  description: 'Bold & Expressive. Vibrant, high-contrast palettes and gradients for engaging, memorable, and modern user experiences.',
