...
export const RAYCAST_PACKAGE: DesignSystemPackage = {
  id: 'raycast',
  name: 'Raycast',
  version: '1.0.0',
  description: 'Developer Tools. Productivity launcher. Sleek dark chrome, vibrant gradient accents.',
  ...
  tokens: {
    colors: {
      ...
      'dark-gray': '#434345',
      'dark-border': '#2f3031',
      'keyboard-key-gradient': '#121212',
      'standard-card': '#101111',
      'nav-links': '#9c9c9d',
      'key-cap-styling': '#121212'
    },
    spacing: {
      unit: '8px',
      values: {
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #07080a, #ffffff, #FF6363, #07080a, #101111...',
