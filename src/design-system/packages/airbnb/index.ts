...
export const AIRBNB_PACKAGE: DesignSystemPackage = {
  id: 'airbnb',
  name: 'Airbnb',
  version: '1.0.0',
  description: 'E-Commerce & Retail. Travel marketplace. Warm coral accent, photography-driven, rounded UI.',
  ...
  components: [
    ...
    },
    {
      ...
      properties: {
        'background': '#ffffff',
        'border-radius': '14px',
        'box-shadow': 'none — separation comes from whitespace and the intrinsic ra',
        'padding': '24px',
        'border': 'none'
      },
    },
    {
      ...
      properties: {
        'background': '#ffffff',
        'border': '1px solid Hairline Gray',
        'border-radius': '32px',
        'padding': '10px 14px',
        'font-family': 'Inter, system-ui, sans-serif',
        'font-size': '14px',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #ff385c, #e00b41, #92174d, #460479, #428bff...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 8px, 14px, 20px, 32px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
