...
export const MONO_PACKAGE: DesignSystemPackage = {
  id: 'mono',
  name: 'Mono',
  version: '1.0.0',
  description: 'Modern & Minimal. Monospace-driven, matrix-inspired design with high-contrast elements, compact density, and a hacker-chic aesthetic.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #37F712, #00A6F4, #00A63D, #FE9900, #FF2157...',
