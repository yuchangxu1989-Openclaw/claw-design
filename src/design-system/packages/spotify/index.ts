...
export const SPOTIFY_PACKAGE: DesignSystemPackage = {
  id: 'spotify',
  name: 'Spotify',
  version: '1.0.0',
  description: 'Media & Consumer. Music streaming. Vibrant green on dark, bold type, album-art-driven.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #1ed760, #121212, #181818, #1f1f1f, #ffffff...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 6px, 500px, 9999px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
