...
export const PUBLICATION_PACKAGE: DesignSystemPackage = {
  id: 'publication',
  name: 'Publication',
  version: '1.0.0',
  description: 'Creative & Artistic. Print-inspired visual language for books, magazines, and reports with editorial grids and expressive typography.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #A855F7, #0A1829, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Oswald, system-ui, sans-serif, Nunito, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
