...
export const VIBRANT_PACKAGE: DesignSystemPackage = {
  id: 'vibrant',
  name: 'Vibrant',
  version: '1.0.0',
  description: 'Bold & Expressive. Lively, colorful design with bold playful typography, warm accents, and dynamic visual energy.',
  ...
  tokens: {
    ...
    typography: {
      fontFamily: {
        heading: 'Fascinate, system-ui, sans-serif',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #7C61D4, #EAAE87, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Fascinate, system-ui, sans-serif, Noto Sans, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
