...
export const BMW_PACKAGE: DesignSystemPackage = {
  id: 'bmw',
  name: 'Bmw',
  version: '1.0.0',
  description: 'Automotive. Luxury automotive. Dark premium surfaces, precise German engineering aesthetic.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #ffffff, #1c69d4, #0653b6, #262626, #757575...',
