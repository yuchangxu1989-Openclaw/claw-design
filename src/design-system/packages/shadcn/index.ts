...
export const SHADCN_PACKAGE: DesignSystemPackage = {
  id: 'shadcn',
  name: 'Shadcn',
  version: '1.0.0',
  description: 'Modern & Minimal. Shadcn/ui-inspired design with minimal, clean components, monochrome palette, and utility-first patterns.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #000000, #111111, #16A34A, #D97706, #DC2626...',
