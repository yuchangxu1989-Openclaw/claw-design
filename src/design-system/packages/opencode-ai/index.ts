...
export const OPENCODE_AI_PACKAGE: DesignSystemPackage = {
  id: 'opencode-ai',
  name: 'Opencode Ai',
  version: '1.0.0',
  description: 'AI & LLM. AI coding platform. Developer-centric dark theme.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #201d1d, #fdfcfc, #9a9898, #302c2c, #646262...',
