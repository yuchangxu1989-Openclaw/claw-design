...
export const MIRO_PACKAGE: DesignSystemPackage = {
  id: 'miro',
  name: 'Miro',
  version: '1.0.0',
  description: 'Design & Creative. Visual collaboration. Bright yellow accent, infinite canvas aesthetic.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #1c1c1e, #ffffff, #5b76fe, #2a41b6, #ffc6c6...',
