...
export const FRIENDLY_PACKAGE: DesignSystemPackage = {
  id: 'friendly',
  name: 'Friendly',
  version: '1.0.0',
  description: 'Creative & Artistic. Approachable, intuitive design with rounded elements, ample whitespace, and soft pastel color palettes.',
  ...
  tokens: {
    ...
    typography: {
      fontFamily: {
        heading: 'Noto Serif Display, system-ui, sans-serif',
        body: 'Noto Serif Display, system-ui, sans-serif',
      },
      sizes: {
        'xs': '11px',
        'sm': '12px',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #F2D9DC, #D9F2D8, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Noto Serif Display, system-ui, sans-serif, Noto Serif Display, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
