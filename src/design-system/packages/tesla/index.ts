...
export const TESLA_PACKAGE: DesignSystemPackage = {
  id: 'tesla',
  name: 'Tesla',
  version: '1.0.0',
  description: 'Automotive. Electric automotive. Radical subtraction, full-viewport photography, near-zero UI.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #3E6AE1, #FFFFFF, #3E6AE1, #FFFFFF, #F4F4F4...',
