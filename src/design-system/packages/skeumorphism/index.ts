...
export const SKEUMORPHISM_PACKAGE: DesignSystemPackage = {
  id: 'skeumorphism',
  name: 'Skeumorphism',
  version: '1.0.0',
  description: 'Morphism & Effects. Real-world mimicry with textured surfaces, 3D effects, and familiar physical metaphors for intuitive digital interfaces.',
  ...
  tokens: {
    ...
    typography: {
      fontFamily: {
        heading: 'Germania One, system-ui, sans-serif',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #FA3C00, #F08321, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Germania One, system-ui, sans-serif, Roboto, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
