...
export const ENTERPRISE_PACKAGE: DesignSystemPackage = {
  id: 'enterprise',
  name: 'Enterprise',
  version: '1.0.0',
  description: 'Professional & Corporate. Clean, high-contrast enterprise design for data-driven workflows with intuitive drag-and-drop patterns and structured layouts.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #072C2C, #FF5F03, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Oswald, system-ui, sans-serif, Ubuntu, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
