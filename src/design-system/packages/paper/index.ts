...
export const PAPER_PACKAGE: DesignSystemPackage = {
  id: 'paper',
  name: 'Paper',
  version: '1.0.0',
  description: 'Retro & Nostalgic. Paper-textured, print-inspired design with minimal colors, clean serif/sans typography, and tactile surface qualities.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #111111, #8B5CF6, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Montserrat, system-ui, sans-serif, Roboto, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
