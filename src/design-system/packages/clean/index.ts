...
export const CLEAN_PACKAGE: DesignSystemPackage = {
  id: 'clean',
  name: 'Clean',
  version: '1.0.0',
  description: 'Modern & Minimal. Simplicity-focused design with ample whitespace, legible typography, and a limited color palette to reduce visual clutter.',
  ...
  constraints: {
    enforce: [
      ...
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Poppins, system-ui, sans-serif, Roboto, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
