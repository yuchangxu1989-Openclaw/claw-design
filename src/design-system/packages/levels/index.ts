...
export const LEVELS_PACKAGE: DesignSystemPackage = {
  id: 'levels',
  name: 'Levels',
  version: '1.0.0',
  description: 'Layout & Structure. Conversion-focused design that removes friction and guides users toward action through clarity, trust, and speed.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #27272A, #8B5CF6, #16A34A, #D97706, #DC2626...',
