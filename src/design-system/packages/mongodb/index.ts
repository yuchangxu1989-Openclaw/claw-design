...
export const MONGODB_PACKAGE: DesignSystemPackage = {
  id: 'mongodb',
  name: 'Mongodb',
  version: '1.0.0',
  description: 'Backend & Data. Document database. Green leaf branding, developer documentation focus.',
  ...
  tokens: {
    colors: {
      ...
      'pure-white': '#ffffff',
      'black': '#000000',
      'neon-mongodb-green': '#00ed64',
      'link-blue': '#006cfa',
      'background': '#00684a',
      'text': '#000000',
      'dark-mode': '#001e2b',
      'apply-mongodb-green': '#00ed64'
    },
    spacing: {
      unit: '8px',
      values: {
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #001e2b, #00ed64, #00684a, #006cfa, #3860be...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 4px, 16px, 100px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
