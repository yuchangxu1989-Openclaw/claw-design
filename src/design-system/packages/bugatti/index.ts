...
export const BUGATTI_PACKAGE: DesignSystemPackage = {
  id: 'bugatti',
  name: 'Bugatti',
  version: '1.0.0',
  description: 'Automotive. Hypercar brand. Cinema-black canvas, monochrome austerity, monumental display type.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #000000, #ffffff, #999999, #ffffff, #999999...',
