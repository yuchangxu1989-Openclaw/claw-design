...
export const WIRED_PACKAGE: DesignSystemPackage = {
  id: 'wired',
  name: 'Wired',
  version: '1.0.0',
  description: 'Media & Consumer. Tech magazine. Paper-white broadsheet density, custom serif display, mono kickers, ink-blue links.',
  ...
  tokens: {
    colors: {
      ...
      'brand-hover-blue': '#057dbc',
      'error': '#e53e3e',
      'disabled': '#a0aec0',
      'top-utility-bar': '#000000',
      'main-nav': '#ffffff',
      'do': '#057dbc',
      'page-canvas': '#ffffff',
      'headline-body-text': '#1a1a1a'
    },
    spacing: {
      unit: '8px',
      values: {
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #000000, #1a1a1a, #ffffff, #057dbc, #ffffff...',
