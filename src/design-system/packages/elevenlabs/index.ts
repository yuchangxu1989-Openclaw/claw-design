...
export const ELEVENLABS_PACKAGE: DesignSystemPackage = {
  id: 'elevenlabs',
  name: 'Elevenlabs',
  version: '1.0.0',
  description: 'AI & LLM. AI voice platform. Dark cinematic UI, audio-waveform aesthetics.',
  ...
  components: [
    ...
    },
    {
      ...
      properties: {
        'background': '#ffffff',
        'border-radius': '16px',
        'box-shadow': 'multi-layer stack (inset + outline + elevation)',
        'padding': '24px',
        'border': 'none'
      },
    },
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #ffffff, #f5f5f5, #f5f2ef, #000000, #4e4e4e...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 16px, 30px, 9999px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
