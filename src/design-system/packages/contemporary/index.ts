...
export const CONTEMPORARY_PACKAGE: DesignSystemPackage = {
  id: 'contemporary',
  name: 'Contemporary',
  version: '1.0.0',
  description: 'Modern & Minimal. Current-era minimalist design with bento grids, dark mode support, and high-performance accessible layouts.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #C800DF, #E60076, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Jost, system-ui, sans-serif, Jost, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
