...
export const RENAULT_PACKAGE: DesignSystemPackage = {
  id: 'renault',
  name: 'Renault',
  version: '1.0.0',
  description: 'Automotive. French automotive. Vibrant aurora gradients, NouvelR typography, bold energy.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #EFDF00, #000000, #FFFFFF, #F8EB4C, #1883FD...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 0px, 50px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
