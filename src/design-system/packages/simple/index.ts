...
export const SIMPLE_PACKAGE: DesignSystemPackage = {
  id: 'simple',
  name: 'Simple',
  version: '1.0.0',
  description: 'Modern & Minimal. Straightforward, no-frills design with clean typography, neutral colors, and intuitive layouts that stay out of the way.',
