...
export const CLICKHOUSE_PACKAGE: DesignSystemPackage = {
  id: 'clickhouse',
  name: 'Clickhouse',
  version: '1.0.0',
  description: 'Backend & Data. Fast analytics database. Yellow-accented, technical documentation style.',
  ...
  tokens: {
    colors: {
      ...
      'use-neon-volt': '#faff69',
      'apply-forest-green': '#166534',
      'apply-pale-yellow': '#f4f692'
    },
    spacing: {
      unit: '8px',
      values: {
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #faff69, #166534, #14572f, #f4f692, #4f5100...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 4px, 64px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
