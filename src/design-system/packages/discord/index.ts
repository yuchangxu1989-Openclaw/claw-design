...
export const DISCORD_PACKAGE: DesignSystemPackage = {
  id: 'discord',
  name: 'Discord',
  version: '1.0.0',
  description: 'Productivity & SaaS. Voice / chat platform. Deep blurple, dark-first surfaces, playful accent moments.',
  ...
  tokens: {
    ...
    typography: {
      fontFamily: {
        heading: '#5865f2, system-ui, sans-serif',
        body: '#5865f2, system-ui, sans-serif',
      },
      sizes: {
        'xs': '11px',
        'sm': '12px',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #5865f2, #4752c4, #7289da, #1e1f22, #2b2d31...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 3px, 4px, 16px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
