...
export const SUPERHUMAN_PACKAGE: DesignSystemPackage = {
  id: 'superhuman',
  name: 'Superhuman',
  version: '1.0.0',
  description: 'Developer Tools. Fast email client. Premium dark UI, keyboard-first, purple glow.',
  ...
  tokens: {
    colors: {
      ...
      'warm-cream-primary': '#e9e5dd',
      'dark-primary': '#292827',
      'dark-surface-card': '#292827',
      'cta-button': '#e9e5dd',
      'border-containment': '#dcd7d3',
      'hero-gradient': '#1b1938',
      'lavender-accents': '#cbb7fb',
      'lavender-purple': '#cbb7fb',
      'use-warm-cream': '#e9e5dd',
      'use-lavender-glow': '#cbb7fb',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #1b1938, #cbb7fb, #292827, #714cb6, #ffffff...',
