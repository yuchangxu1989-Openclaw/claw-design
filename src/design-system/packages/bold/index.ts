...
export const BOLD_PACKAGE: DesignSystemPackage = {
  id: 'bold',
  name: 'Bold',
  version: '1.0.0',
  description: 'Bold & Expressive. Strong visual presence with heavyweight typography, high-contrast colors, and commanding layouts.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #0077BC, #009866, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Archivo Black, system-ui, sans-serif, Archivo Black, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
