...
export const CLAYMORPHISM_PACKAGE: DesignSystemPackage = {
  id: 'claymorphism',
  name: 'Claymorphism',
  version: '1.0.0',
  description: 'Morphism & Effects. Soft, rounded 3D-like shapes mimicking malleable clay with playful, puffy elements and colorful surfaces.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #3B82F6, #FFFFFF, #16A34A, #D97706, #DC2626...',
        check: (_html, _pkg) => null,
      },
      {
        id: 'typographyStack',
        description: 'Only use brand-defined font families: Poppins, system-ui, sans-serif, Montserrat, system-ui, sans-serif',
        check: (_html, _pkg) => null,
      },
      {
        id: 'spacingScale',
