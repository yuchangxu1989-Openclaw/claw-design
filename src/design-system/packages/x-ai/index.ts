...
export const X_AI_PACKAGE: DesignSystemPackage = {
  id: 'x-ai',
  name: 'X Ai',
  version: '1.0.0',
  description: 'AI & LLM. Elon Musk\'s AI lab. Stark monochrome, futuristic minimalism.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #ffffff, #1f2228, #ffffff, #ffffff, #1f2228...',
