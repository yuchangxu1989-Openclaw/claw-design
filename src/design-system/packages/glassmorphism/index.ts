...
export const GLASSMORPHISM_PACKAGE: DesignSystemPackage = {
  id: 'glassmorphism',
  name: 'Glassmorphism',
  version: '1.0.0',
  description: 'Morphism & Effects. Frosted glass effect with translucent layers, subtle blur, and luminous borders for depth and modern elegance.',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #1856FF, #3A344E, #07CA6B, #E89558, #EA2143...',
