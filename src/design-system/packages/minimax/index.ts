...
export const MINIMAX_PACKAGE: DesignSystemPackage = {
  id: 'minimax',
  name: 'Minimax',
  version: '1.0.0',
  description: 'AI & LLM. AI model provider. Bold dark interface with neon accents.',
  ...
  tokens: {
    ...
    typography: {
      fontFamily: {
        heading: '#18181b, system-ui, sans-serif',
        body: '#18181b, system-ui, sans-serif',
      },
      sizes: {
        'xs': '11px',
        'sm': '12px',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #1456f0, #3daeff, #ea5ec1, #bfdbfe, #60a5fa...',
      ...
      },
      {
        ...
        description: 'Border radius must use defined scale: 8px, 13px, 20px, 9999px, 999px',
        check: (_html, _pkg) => null,
      }
    ],
    forbid: [
