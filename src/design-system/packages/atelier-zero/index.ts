...
export const ATELIER_ZERO_PACKAGE: DesignSystemPackage = {
  id: 'atelier-zero',
  name: 'Atelier Zero',
  version: '1.0.0',
  description: 'Editorial · Studio. A magazine-grade, collage-driven visual system: warm paper canvas, surreal',
  ...
  constraints: {
    enforce: [
      {
        id: 'colorPalette',
        description: 'Only use brand-defined colors: #efe7d2, #efe7d2, #ece4cf, #ddd2b6, #f7f1de...',
